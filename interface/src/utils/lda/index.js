...
// import stopwords_en from "./stopwords/stopwords_en.js";
// import stopwords_es from "./stopwords/stopwords_es.js";
// import stopwords_de from "./stopwords/stopwords_de.js";
import stopwords_en_las2024 from "./stopwords/stopwords_en_las2024.js";

var stopWordLists = {
  // en: stopwords_en,
  // es: stopwords_es,
  // de: stopwords_de,
  en_las2024: stopwords_en_las2024,
};
...
export default function (
  ...
  if (sentences && sentences.length > 0) {
    ...
    languages.forEach(function (value) {
      stopwords = stopwords.concat(stopWordLists[value]);
    });
